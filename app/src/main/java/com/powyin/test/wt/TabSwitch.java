...
public class TabSwitch extends LinearLayout {
    ...
    public TabSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    //    if(selectDrawable==null){
        //    selectDrawable = context.getResources().getDrawable(R.drawable.powyin_switch_slide_switch_select);
    //    }
